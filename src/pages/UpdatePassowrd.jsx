            ...
            <div className="max-w-[500px] p-4 lg:p-8">
                ...
                <form onSubmit={handleOnSubmit}>
                    <label className="relative">
                        ...
                        />
                         <span className='text-white absolute right-3 top-[38px] z-[10] cursor-pointer'  onClick={()=> setShowPassword((prev) => !prev)}
                          >
                     {
                    ...
                    <label className="relative mt-3 block">
                        ...
                        placeholder='Confirm Password'
                         className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5"
                        />
                         <span className='text-white absolute right-3 top-[38px] z-[10] cursor-pointer'  onClick={()=> setShowConfirmPassword((prev) => !prev)}
